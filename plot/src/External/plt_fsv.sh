...
# svn $Id: plt_fsv.sh 833 2017-01-24 22:20:16Z arango $
#::::::::::::::::::::::::::::::::::::::::::::::::::::: Hernan G. Arango :::
...
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
#                                                                       :::
# This script can use to plot the results for the Forcing Singular      :::
# Vector (FTE) Driver using ROMS plotting package. The FTEs are         :::
...
$TITLE2
$TITLE3
Surface U-momentum Stress Eigenvector $eigenvector
1     NFIELDS: number of fields to plot. Line below, field(s) types:
...
EOF
    ...
    if ( $n == 1) then
      ...
      med -e 'r gmeta' -e 'a gmeta.sustr' >> & $LOG
    endif
...
$TITLE2
$TITLE3
Surface V-momentum Stress Eigenvector $eigenvector
1     NFIELDS: number of fields to plot. Line below, field(s) types:
...
EOF
    ...
    if ( $n == 1) then
      ...
      med -e 'r gmeta' -e 'a gmeta.svstr' >> & $LOG
    endif

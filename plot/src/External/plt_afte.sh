...
# svn $Id: plt_afte.sh 833 2017-01-24 22:20:16Z arango $
#::::::::::::::::::::::::::::::::::::::::::::::::::::: Hernan G. Arango :::
...
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
#                                                                       :::
# This script can use to plot the results for the Adjoint Finite Time   :::
# Eigenmodes (AFTE) Driver using ROMS plotting package. The AFTEs are   :::
...
set pri_file=${MyDir}/gyre3d_adj.nc
...
if ( $Lmulti == 1 ) then
  set Nrec=`ls -1 ${MyDir}/*_adj_*.nc | wc -l`      # count files
  echo " Nfiles = ${Nrec} "
else
...
while ($n < $Nrec)
  ...
  if ( $Lmulti == 1 ) then
    ...
    set pri_file=${MyDir}/gyre3d_adj_${vec}.nc

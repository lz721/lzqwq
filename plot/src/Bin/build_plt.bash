!/bin/bash
#
# svn $Id: build_plt.bash 833 2017-01-24 22:20:16Z arango $
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
# to the code and inputs on differing machines.
 ...
 export       MY_PLT_SRC=${MY_ROOT_DIR}/plot
...
# these configurations files up-to-date.
 ...
 export         COMPILERS=${MY_PLT_SRC}/src/Compilers
...
#export      NCAR_VERSION=NCARG410
#export      NCAR_VERSION=NCARG422
#export      NCAR_VERSION=NCARG430
#export      NCAR_VERSION=NCARG431
#export      NCAR_VERSION=NCARG441
 export      NCAR_VERSION=NCARG520
...
#export         PLT_DEBUG=on            # use Fortran debugging flags
 export         PLT_LARGE=on            # activate 64-bit compilation
...
if [ -n "${USE_MY_LIBS:+1}" ]; then
  ...
  case "$FORT" in
    ...
    ifort )
      ...
      export          NCARG_ROOT=/opt/intelsoft/ncarg
    ...
    pgi )
      ...
      export          NCARG_ROOT=/opt/pgisoft/ncarg
    ...
    gfortran )
      ...
      export          NCARG_ROOT=/opt/gfortransoft/ncarg
...
# Put the binary to execute in the following directory.
 ...
 export        PLT_BINDIR=${HOME}/bin
#export        PLT_BINDIR=${MY_PROJECT_DIR}

# Put the f90 files in a project specific Build directory to avoid conflict
# with other projects.

 export       SCRATCH_DIR=${MY_PROJECT_DIR}/Build_plt

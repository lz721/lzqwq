# svn $Id: Darwin-ifort.mk 833 2017-01-24 22:20:16Z arango $
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
#
       ...
       NCARG_ROOT ?= /opt/intelsoft/ncarg
          LDFLAGS := -Vaxlib
               AR := ar
          ARFLAGS := r
            MKDIR := mkdir -p
...
ifdef USE_NETCDF4
        NC_CONFIG ?= /opt/intelsoft/serial/netcdf4/bin/nc-config
...
ifdef USE_NETCDF4
 ifdef USE_MPIF90
       MPIF90_DIR ?= /opt/intelsoft/openmpi/bin

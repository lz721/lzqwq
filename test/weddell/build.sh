...
setenv ROMS_APPLICATION      WEDDELL
...
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DICESHELF"
...
if ($?BACK_COMPATIBILITY) then
 ...
 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DEAST_M2FLATHER"
 ...
 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DWEST_VOLCONS"
endif

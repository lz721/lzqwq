...
export   ROMS_APPLICATION=TEST_HEAD
...
# many definitions as you want by appending values.
 ...
 export      MY_CPP_FLAGS="-DSEDIMENT"
 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DSUSPLOAD"
 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DBEDLOAD_MPM"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DBEDLOAD_SOULSBY"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DSED_DENS"

#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DANA_SEDIMENT"
...
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DCURVGRID"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DUV_COR"
...
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DANA_VMIX"
...
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DMB_Z0BIO"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DMB_Z0BL"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DMB_Z0RIP"

#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DSG_LOGINT"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DSSW_LOGINT"

...
setenv ROMS_APPLICATION      TEST_HEAD
...
# many definitions as you want by appending values.
 ...
 setenv MY_CPP_FLAGS "-DSEDIMENT"
 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DSUSPLOAD"
 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DBEDLOAD_MPM"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DBEDLOAD_SOULSBY"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DSED_DENS"

#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DANA_SEDIMENT"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DANA_GRID"
...
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DCURVGRID"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DUV_COR"
...
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DANA_VMIX"
...
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DMB_Z0BIO"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DMB_Z0BL"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DMB_Z0RIP"

#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DSG_LOGINT"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DSSW_LOGINT"

#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DANA_WWAVE"
 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DSWAN_COUPLING"

...
# svn $Id: plot_op_tlm.sh 831 2017-01-24 21:38:51Z arango $
#::::::::::::::::::::::::::::::::::::::::::::::::::::: Hernan G. Arango :::
...
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
#                                                                       :::
# This script can use to plot the results for the Optimal Perturbations :::
# (OP) Driver using ROMS plotting package.  The OP singular vectors are :::
# plotted from a single or multiple NetCDF files.                       :::
#                                                                       :::
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
set MED="/opt/gfortransoft/ncarg/bin/med"
set CONVERT=0
...
set pri_file=${MyDir}/channel_tlm.nc
set sec_file=${MyDir}/channel_adj.nc
...
10             depths (<0), levels (>0) or isopycnals (>1000) to plot

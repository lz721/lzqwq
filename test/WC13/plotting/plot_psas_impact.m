%
% PLOT_PSAS_IMPACT:  Plots observation impact for 4D-PSAS
%

% svn $Id: plot_psas_impact.m 831 2017-01-24 21:38:51Z arango $
%===========================================================================%
...
Inpa ='../PSAS_impact/wc13_ads.nc';    % adjoint forcing file (dI/dx)
Obs  ='../Data/wc13_obs.nc';           % observation file
Mod  ='../PSAS_impact/wc13_mod.nc';    % 4D-PSAS impact file.
...
ylabel('N_{obs}');
title('4D-PSAS Observation Impact');
...
if (PRINT),
  print -dpng -r300 plot_psas_impact.png
end,

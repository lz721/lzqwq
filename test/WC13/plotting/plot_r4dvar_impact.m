%
% PLOT_R4DVAR_IMPACT:  Plots observation impact for R4D-Var
%

% svn $Id: plot_r4dvar_impact.m 831 2017-01-24 21:38:51Z arango $
%===========================================================================%
...
Inpa ='../R4DVAR_impact/wc13_ads.nc';  % adjoint forcing file (dI/dx)
Obs  ='../Data/wc13_obs.nc';           % observation file
Mod  ='../R4DVAR_impact/wc13_mod.nc';  % R4D-Var impact file.
RPmod='../R4DVAR/wc13_mod.nc';         % 4D-PSAS file

%
% PLOT_PSAS_INCREMENTS:  Plot the 4D-PSAS increments
%

% svn $Id: plot_psas_increments.m 831 2017-01-24 21:38:51Z arango $
%===========================================================================%
...
% Compute 4D-PSAS increments by substracting prior from

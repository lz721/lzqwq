%
% PLOT_R4DVAR_SENSITIVITY:  Plots observation sensitivity for R4D-Var
%

% svn $Id: plot_r4dvar_sensitivity.m 831 2017-01-24 21:38:51Z arango $
%===========================================================================%
...
Inp0 ='../R4DVAR/wc13_tlm_001.nc';         % prior circulation file
Inp1 ='../R4DVAR/wc13_fwd_001.nc';         % posterior circulation file
Inpa ='../R4DVAR_sensitivity/wc13_ads.nc'; % adjoint forcing file (dI/dx)
Obs  ='../Data/wc13_obs.nc';               % observation file
Mod  ='../R4DVAR_sensitivity/wc13_mod.nc'; % R4D-Var impact file.
RPmod='../R4DVAR/wc13_mod.nc';             % R4D-Var file
...
RPM=nc_read(RPmod,'RPmodel_initial');
...
ylabel('N_{obs}')
title('R4D-Var Observation Sensitivity');
...
if (PRINT),
  print -dpng -r300 plot_r4dvar_sensitivity.png
end,

...
setenv ROMS_APPLICATION      DAMEE_4
...
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DTS_C4HADVECTION -DTS_C4VADVECTION
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DTS_U3HADVECTION -DTS_C4VADVECTION"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DTS_C2HADVECTION -DTS_C4VADVECTION"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DTS_MPDATA"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DTS_U3ADV_SPLIT"

#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DUV_U3ADV_SPLIT"

 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DTS_DIF2 -DMIX_GEO_TS"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DTS_DIF4 -DMIX_GEO_TS"
 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DUV_VIS2 -DMIX_GEO_UV"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DUV_VIS4 -DMIX_GEO_UV"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DUV_VIS4 -DMIX_S_UV"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DCLIMA_TS_MIX"
...
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DWRITE_WATER"
